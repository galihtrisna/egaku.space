      ...
      <section class="dark:bg-jacarta-800 bg-light-base relative pb-12 pt-28">
        ...
        <div class="container">
          <div class="text-center">
            <h2 class="font-display text-jacarta-700 mb-2 text-4xl font-medium dark:text-white">{{Auth::user()->name}}</h2>
            <div
            ...
            <span class="text-jacarta-400">Joined {{Auth::user()->created_at->format('M  Y')}}</span>
