      ...
      <div class="container">
        <div class="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
          ...
          <div class="col-span-full sm:col-span-3 md:col-span-2 md:col-start-7">
            <h3 class="font-display text-jacarta-700 mb-6 text-sm dark:text-white">Visual Discovery</h3>
            <ul class="dark:text-jacarta-300 flex flex-col space-y-1">
              <li>
                <a href="#" class="hover:text-accent dark:hover:text-white">All Categories</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" class="hover:text-accent dark:hover:text-white">Office</a>
              </li>
              <li>
                <a href="#" class="hover:text-accent dark:hover:text-white">Animals</a>
              </li>
              <li>
