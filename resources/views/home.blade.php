...
<main>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
              <div class="container relative z-10 h-full pt-40">
                ...
                <a href="user.html" class="text-2xs font-medium text-white">By 051_Hart</a>
              </div>
              <img src="img/hero/hero_slide_1.jpg" class="absolute inset-0 h-full w-full object-cover" alt="slide 1" />
            </div>
            <div class="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
              <div class="container relative z-10 h-full pt-40">
                <h2 class="font-display text-2xl font-semibold text-white">
                ...
                <a href="user.html" class="text-2xs font-medium text-white">By THE OVERSEERS</a>
              </div>
              <img
                src="./img/pixel.jpg"
            ...
            <div class="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
              <div class="container relative z-10 h-full pt-40">
                ...
                <a href="user.html" class="text-2xs font-medium text-white">Generous Shiba Club</a>
              </div>
              <img
                src="./img/pixel.jpg"
            ...
            <div class="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
              <div class="container relative z-10 h-full pt-40">
                ...
                <a href="user.html" class="text-2xs font-medium text-white">LeeCookNZ</a>
              </div>
              <img
                src="./img/pixel.jpg"
            ...
            <div class="swiper full-slider-thumbs">
              <div class="swiper-wrapper">
                <div class="swiper-slide cursor-pointer rounded p-5">
                  <img src="img/hero/hero_slide_1_thumb.jpg" class="w-full rounded-lg" alt="thumb 1" />
                ...
                <div class="swiper-slide cursor-pointer rounded p-5">
                  <img src="img/hero/hero_slide_2_thumb.jpg" class="w-full rounded-lg" alt="thumb 2" />
                  <div class="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                    <div class="progress bg-accent absolute h-0.5 w-0"></div>
                  </div>
                </div>
                <div class="swiper-slide cursor-pointer rounded p-5">
                  <img src="img/hero/hero_slide_3_thumb.jpg" class="w-full rounded-lg" alt="thumb 3" />
                  <div class="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                    <div class="progress bg-accent absolute h-0.5 w-0"></div>
                  </div>
                </div>
                <div class="swiper-slide cursor-pointer rounded p-5">
                  <img src="img/hero/hero_slide_4_thumb.jpg" class="w-full rounded-lg" alt="thumb 4" />
                  <div class="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                    <div class="progress bg-accent absolute h-0.5 w-0"></div>
                  </div>
                </div>
      ...
      <!-- Browse by Category -->
      <section class="py-24">
        <h2 class="font-display text-jacarta-700 mb-8 text-center text-3xl dark:text-white">Browse by category</h2>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <article>
                  ...
                  >
                    <figure class="bg-green rounded-t-[0.625rem]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Art</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="bg-orange rounded-t-[0.625rem]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Collectibles</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="bg-accent rounded-t-[0.625rem]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Domain Names</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="rounded-t-[0.625rem] bg-[#46C7E3]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Virtual Worlds</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="rounded-t-[0.625rem] bg-[#737EF2]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Sport</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="bg-blue rounded-t-[0.625rem]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Photography</span>
                    </div>
                  </a>
                </article>
              </div>
              <div class="swiper-slide">
                <article>
                  <a
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 block rounded-[1.25rem] border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg"
                  >
                    <figure class="rounded-t-[0.625rem] bg-[#F35BC7]">
                      <img
                    ...
                    <div class="mt-4 text-center">
                      <span class="font-display text-jacarta-700 text-lg dark:text-white">Music</span>
                    </div>
                  </a>
                </article>
              </div>
      ...
      <section class="py-24">
        <div class="container">
          <div class="flex flex-col space-y-5 lg:flex-row lg:space-y-0 lg:space-x-7">
            <div class="dark:bg-jacarta-800 bg-light-base rounded-[1.25rem] p-12 lg:w-1/3">
              <h2 class="text-jacarta-700 font-display mb-8 text-center text-3xl font-semibold dark:text-white">
                Today's Drops
              </h2>
              <div class="flex flex-col space-y-5">
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  <figure class="mr-4 shrink-0">
                    <a href="collection.html" class="relative block">
                      ...
                      <div
                        class="dark:border-jacarta-600 bg-jacarta-700 absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white text-xs text-white"
                      >
                        1
                      </div>
                      <div
                        class="dark:border-jacarta-600 bg-green absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white"
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">7,080.95 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  <figure class="mr-4 shrink-0">
                    <a href="collection.html" class="relative block">
                      ...
                      <div
                        class="dark:border-jacarta-600 bg-jacarta-700 absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white text-sm text-white"
                      >
                        2
                      </div>
                      <div
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">6,548,133 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">4,823,927 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">3,186 ETH</span>
                  </div>
                </div>
              </div>
              <a href="collection.html" class="text-accent mt-8 block text-center text-sm font-bold tracking-tight"
                >View All Drops</a
              >
            </div>
              ...
              <div class="flex flex-col space-y-5">
                ...
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">3,027 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">2,586 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">2,347.85 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">2,115.71 ETH</span>
                  </div>
                </div>
              </div>
              <a href="collection.html" class="text-accent mt-8 block text-center text-sm font-bold tracking-tight"
              ...
              <div class="flex flex-col space-y-5">
                ...
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">2,027 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">1,989.70 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">1,726.70 ETH</span>
                  </div>
                </div>
                <div
                  class="border-jacarta-100 dark:bg-jacarta-700 flex rounded-[1.25rem] border bg-white py-4 px-7 transition-shadow hover:shadow-lg dark:border-transparent"
                >
                  ...
                  <div>
                    ...
                    <span class="dark:text-jacarta-300 text-sm">1,589.03 ETH</span>
                  </div>
                </div>
              </div>
              <a href="collection.html" class="text-accent mt-8 block text-center text-sm font-bold tracking-tight"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body p-6">
            ...
            <div class="text-right">
              <span class="dark:text-jacarta-400 text-sm">Balance: 0.0000 WETH</span>
            </div>
